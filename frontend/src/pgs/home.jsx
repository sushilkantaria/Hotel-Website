  ...
  const services = [
    {
      ...
      imgSrc:
        'https://t3.ftcdn.net/jpg/06/55/45/12/360_F_655451228_jAJGMKY329hxF3NRDfGaDUXV3eiMkZbD.jpg',
    ...
    },
    {
      ...
      imgSrc:
        'https://thumb.ac-illust.com/84/84048536b40fcee5949708eea96a5461_t.jpeg',
    ...
    },
    {
      ...
      imgSrc:
        'https://media.cnn.com/api/v1/images/stellar/prod/160502155618-terranea-vista-pool.jpg?q=w_1600,h_900,x_0,y_0,c_fill',
    ...
    },
    {
      ...
      imgSrc:
        'https://cache.marriott.com/content/dam/marriott-renditions/HKGXR/hkgxr-run-1823-hor-pano.jpg?downsize=*:666',
    ...
    },
    {
      ...
      imgSrc:
        'https://media.cntraveler.com/photos/548217fcb6e03e8c2d0ca02e/master/w_1920%2Cc_limit/Makanyane_Safari_Lodge_Elephant.jpg',
  ...
  return (
    <div className="home-pg">
      ...
      <section className="grey-section">
        ...
        <p>
          Our resort is crafted to elevate your experiences, from uncovering
          hidden gems to enjoying unparalleled services. Whether you’re seeking
          adventure, tranquility, or unforgettable moments, we are here to make
          it happen. Let us guide you to new horizons filled with joy and
          discovery.
        </p>
      </section>
